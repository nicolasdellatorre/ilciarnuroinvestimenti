            ...
            <?php
                if (!isset($_GET["asset"])) {
                    ...
                    echo "<div style='text-align: center; left: 3vw; margin-right: 1vh; width: 44vw;'>";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            echo "<div class='infoStock'>";
                                ...
                                $giorniTrascorsi = floor($timestamp / (60 * 60 * 24));
                        ...
                        echo "<div class='infoStock'>";
                            ...
                            if ($row["dividendo"] > 0) {
                                echo "<p>Frequenza " . $row["freqDividendo"] . "</p>";
                                echo "<p>Prossimo " . number_format($posseduto * $row["dividendo"], 2, '.', "'") . "</p>";
                            }
                        echo "</div>";
                    ...
                    echo "<div>";
                        ...
                        echo "<div style='display:flex;'>";
                            echo "<p style='width: 53vw;'>";
                                ...
                                echo "<b>" . $row["settoreMercato"] . " - " . $row["settoreSpecifico"] . "</b>";
                            echo "</p>";
                    ...
                    for ($i = 365; $i >= 0; $i--) {
                        ...
                        $annuale_data[]   = previous($row["variability"], $row["volatility"], $row["noisiness"], $row["prezzoPartenza"], $row["seed"], gameTimer() - $i);
                    }
                    ...
                    let currentDataset = getDataset('annuale');
