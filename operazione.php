<?php
    ...
    if ($_GET["azione"] == "compra") {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $sql = "INSERT INTO titoliacquistati (username, IDtitolo, dataPrimoAcquisto, quantitaAttuale) VALUES('" . $_SESSION["username"] . "', '" . $_GET["asset"] . "', '" . date('Y-m-d', gameTimer()) . "', $quantita);";
        }
